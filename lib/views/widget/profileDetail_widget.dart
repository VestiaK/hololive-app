                  ...
                  Wrap(
                    ...
                    children: [
                      SocialMediaProfile(
                        ...
                        url: 'https://www.youtube.com/@KoboKanaeru',
                      ),
                      SocialMediaProfile(
                        label: 'X',
                        icon: FontAwesomeIcons.xTwitter,
                        iconColor: Colors.black,
                        url: 'https://x.com/kobokanaeru',
                      ),
                      SocialMediaProfile(
                        label: 'Instagram',
                        icon: FontAwesomeIcons.instagram,
                        iconColor: Colors.purple,
                        url: 'https://www.instagram.com/kobokanaeru/',
                      ),
                      SocialMediaProfile(
                        label: 'TikTok',
                        icon: FontAwesomeIcons.tiktok,
                        iconColor: Colors.black,
                        url: 'https://www.tiktok.com/@kobokanaeru',
                      ),
                      SocialMediaProfile(
                        label: 'Facebook',
                        icon: FontAwesomeIcons.facebook,
                        iconColor: Colors.blue,
                        url: 'https://www.facebook.com/KoboKanaeru',
                      ),
                    ],
                  ),
                ],
